...
describe("Numbers:", function () {
  ...
  describe("to Pa’O numerals:", function () {
    it("should return \u{116D1}\u{116D0} when the value is 10", function () {
      var ret = myanmarNumbers(10, "pao");
      assert.equal(ret, "\u{116D1}\u{116D0}");
    });
  });

  describe("from Pa’O numerals:", function () {
    it("should return 10 when the value is \u{116D1}\u{116D0}", function () {
      var ret = myanmarNumbers("\u{116D1}\u{116D0}");
      assert.equal(ret, 10);
    });
  });

  describe("to Eastern Pwo numerals:", function () {
    it("should return \u{116DB}\u{116DA} when the value is 10", function () {
      var ret = myanmarNumbers(10, "pwo");
      assert.equal(ret, "\u{116DB}\u{116DA}");
    });
  });

  describe("from Eastern Pwo numerals:", function () {
    it("should return 10 when the value is \u{116DB}\u{116DA}", function () {
      var ret = myanmarNumbers("\u{116DB}\u{116DA}");
      assert.equal(ret, 10);
    });
  });
});
